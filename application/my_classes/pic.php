...
/*############################################
Sample :
$thumb=new thumbnail("100_2301.JPG");			// generate image_file, set filename to resize
...
$thumb->save("resized.jpg");				// save your thumbnail to file
----------------------------------------------
Note :
- GD must Enabled
...
class thumbnail
{
	...
	function show()
	{
		$form = strtolower($this->img["format"]);
		//show thumb
	...
	function save($save="")
	{
		...
		if ($this->img["format"]=="JPG" || $this->img["format"]=="JPEG") {
			//JPEG
			//echo $this->img["src"]."something"; exit;
